...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: <Setting a cookie is fine here>
    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-3.5 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(7))+2px)]"
      ...
      >
        <div
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm"
          data-sidebar="sidebar"
